...
export const getFullscreenButton = (state: RootState) => getAppState(state).fullscreenButton;
export const getPauseButton = (state: RootState) => getAppState(state).pauseButton;
export const getMuteState = (state: RootState) => getAppState(state).muteState;
export const getMuteButton = (state: RootState) => getAppState(state).muteButton;
export const getIncreaseVolumeButton = (state: RootState) => getAppState(state).increaseVolumeButton;
export const getDecreaseVolumeButton = (state: RootState) => getAppState(state).decreaseVolumeButton;
