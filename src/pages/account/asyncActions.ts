...
export const asyncAccountActions = {
  updateProfile: (params: UpdateProfileParams): AppThunk<Promise<void>> => async (dispatch) => {
    try {
  ...
  updateAvatar: (params: UpdateAvatarParams): AppThunk<Promise<void>> => async (dispatch) => {
    try {
